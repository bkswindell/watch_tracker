...
**Checkpoint:** `96dac615f9d344941696b90420c4533a384efad2` — `fix(security): align session cookie idle lifetime`
...
- **Remote/CI:** Core implementation checkpoint `96dac615f9d344941696b90420c4533a384efad2` passed Validate Core run `32789056484`, including isolated PostgreSQL integration, image scan, SBOM, and Compose smoke. The progress-record head is pushed separately and its remote SHA is verified below.
