...
- **Remote/CI:** Core implementation checkpoint `96dac615f9d344941696b90420c4533a384efad2` was pushed; its Validate Core workflow is pending. CI will provide the isolated PostgreSQL integration, image scan, SBOM, and Compose smoke evidence.
