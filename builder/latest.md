...
- **Remote/CI:** feature checkpoint `c01000240d75b6102ade40c7ac45458aefee71e4` and progress parent `c235859` both passed Validate Core; latest completed run `32786887814` was green. The final progress-only head requires the same Validate Core gate.
